...
app.layout = html.Div([
    ...
    html.Div(id="country-info", style={"margin-top": "20px", "font-size": "20px", "background-color": "white", "width": "90%", "border-radius": "50px", "margin-left": "5%"}),
...
def display_country_info(_):
    ...
    Latitude: {country_data.iloc[0]['latitude']}
    Longitude: {country_data.iloc[0]['longitude']}
